...
export default function CadastroConvenioModal({ isOpen, onClose }: CadastroConvenioModalProps) {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      toast.error(
        `Erro ao cadastrar convênio: ${error instanceof Error ? error.message : String(error)}`,
        {
          style: {
            background: "var(--toast-error)",
            color: "var(--toast-error-foreground)",

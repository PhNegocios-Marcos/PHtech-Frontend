...
const schema = z.object({
  ...
  inicio: z.date({ required_error: "Data de início obrigatória" }),
  fim: z.date({ required_error: "Data de fim obrigatória" })
});
...
export default function CadastroTabelaModal({
  isOpen,
  onClose,
  produto
}: CadastroTabelaModalProps) {
